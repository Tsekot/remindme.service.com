...
public class ReminderController {
    ...
    @ResponseBody
    public Remind getReminder(@PathVariable("id") long remind) {
        return service.getById(remind);
    }
